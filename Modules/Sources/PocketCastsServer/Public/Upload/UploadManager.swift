...
public class UploadManager: NSObject {
    ...
    private lazy var wifiOnlyBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: HostBundleIdentifier.value + ".PCUploadBackgroundSession")
    ...
    private lazy var cellularBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: HostBundleIdentifier.value + ".PCUploadManualSession")
